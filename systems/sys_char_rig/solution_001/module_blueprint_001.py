...
class ModuleBP:
    def __init__(self, module_data):
        ...
        # Attributes:
            module_data(dict): Centric data store. 
        # Returns: N/A
        '''

        # self.data = module_data
        external_plg_dict = module_data['external_plg_dict']
        skeleton_dict = module_data['skeleton_dict']
        fk_dict = module_data['fk_dict']
        ik_dict = module_data['ik_dict']
        axis_dict = module_data['axis_dict']
