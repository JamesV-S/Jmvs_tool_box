...
spine_data = {
    ...
    "ik_dict":{
        "ik_pos":{
            'ctrl_ik_spine_bottom_0_M':[0.0, 94.06878351483358, 1.5987211554602254], 
            'ctrl_ik_spine_middle_0_M': [0.0, 109.06878351483363, 1.5987211554602254], 
            'ctrl_ik_spine_top_0_M': [0.0, 124.06878351483367, 1.5987211554602254]
            },
        "ik_rot":{
