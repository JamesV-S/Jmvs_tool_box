...
class SystemBipedLeg:
    ...
    def cr_skn_twist_joint_chain(self, twist_name, logic_curve, start_pos, end_pos):
        ...
        # Description:
           ...
           by the 'ctrl_ik_BipedLeg_shoulder_0_L'.  
           Naming convention = jnt_skn_BipedLeg_upper#/lower#_0_L
        # Arguments:
    ...
    def wire_ik_logic_elements(self, input_grp, logic_jnt_list, ik_ctrl_list, d_shld_wrist, d_shld_elb, d_elb_wrist):
        ...
        logic_hdl = f"hdl_{self.dm.mdl_nm}_logic_{self.dm.unique_id}_{self.dm.side}" # hdl_BipedLeg_0_L
    ...
    # module_blueprint.py > wire_parent_skn_twist_joint_matrix()
    ...
    # module_blueprint.py > wire_rotations_on_twist_joints()
